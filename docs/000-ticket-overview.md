...
| [033](./033-text-decoration-toolbar.md) | テキスト装飾ツールバー（記法挿入）とハイライト | 将来 | 未着手 | 005, 007, 008, 013, 028-2 |

> 注: 028〜032（Pro機能候補・デッキ/カードカスタマイズ・カード表示テーマ・フォント設定・デッキ統合/復元・検索絞り込み・高度な通知・アーカイブ）は本表に未反映。各チケットファイルを参照。
...
graph TD
    ...
    style 033 fill:#9E9E9E,color:#fff
```
