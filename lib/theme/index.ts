...
// テキストハイライト（==…==）の背景色。カードテーマ（paper/sky/rose…）の上に乗るため
// 半透明にして下地に色を混ぜ、全テーマで「マーカーでなぞった」見た目を保つ。
// 文字色は変えない（描画側で Text の color を指定せず親から継承させる）。
// ライトは文字が濃いのでアルファ高め、ダークは明るい文字を潰さないようアルファ低め。
export const HIGHLIGHT_COLORS = {
  light: 'rgba(255, 196, 0, 0.45)',
  dark: 'rgba(255, 196, 0, 0.28)',
} as const;
